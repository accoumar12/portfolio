    ...
    <div class="max-w-6xl mx-auto px-6 py-12">
      <div class="mb-8">
        ...
        <p class="text-slate-400">
          Manage and view portfolio feedback submissions
        </p>
      </div>
      ...
      {#if data.emailMode}
        <div class="bg-blue-900/30 border border-blue-500 rounded-lg p-6 mb-8">
          <div class="flex items-center mb-4">
            ...
            <h2 class="text-xl font-semibold text-blue-200">
      ...
      {#if data.feedbacks.length === 0}
        <div class="text-center py-12">
          ...
          <h3 class="text-xl text-slate-300 mb-2">
            No feedback stored locally
          </h3>
          <p class="text-slate-400">
            All feedback is now sent directly to your email inbox.
          </p>
        </div>
      {:else}
        <div class="mb-4 flex justify-between items-center">
          ...
          <div class="flex items-center space-x-4">
            {#if cleanupMessage}
              <div
                class="text-sm {cleanupMessage.startsWith('✓')
                  ? 'text-green-400'
                  : 'text-red-400'}"
              >
                {cleanupMessage}
          ...
          {#each data.feedbacks as feedback, index}
            <div class="bg-slate-800 rounded-lg p-6 border border-slate-700">
              <div class="flex justify-between items-start mb-4">
                <div class="flex items-center space-x-4">
                  <span
                    class="text-sm bg-violet-900 text-violet-200 px-3 py-1 rounded-full"
                  >
